report 52077 "Sales Cr.Memo-InforPress New"
{
    // 148 OS.RM  07/06/2017  VEN.003   Abono de Venta
    // EX-OMI 180319 incluir moneda
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/layouts/Sales Cr.Memo-InforPress New.rdl';
    Caption = 'Credit Note - Sale';
    Permissions = TableData 7190=rimd,
        TableData "Posted Assembly Line"=rimd,
        tabledata "MemIntAcumulados Inv"=rimd,
        tabledata "Line Fee Note on Report Hist."=rimd,
        tabledata "Sales Cr.Memo Header"=rimd; //EX-SGG 240322
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Cr.Memo Header")
        {
            ...
            RequestFilterHeading = 'Registered credit notes';
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(OrderNo_SalesInvHeader; "Sales Invoice Header"."Return Order No.")
                    {
                    }
                    ...
                    dataitem("Sales Invoice Line";115)
                    {
                ...
                begin
                    IF NOT CurrReport.PREVIEW THEN SalesCrMemoCountPrinted.RUN("Sales Invoice Header");
                end;
                trigger OnPreDataItem()
                begin
            ...
            begin
                CustomerLan.Get("Sales Invoice Header"."Sell-to Customer No.");
                if CustomerLan."Language Code" <> '' then CurrReport.LANGUAGE:=cLanguage.GetLanguageID(CustomerLan."Language Code")
                else
                ...
                IF "Return Order No." = '' THEN OrderNoText:=''
                ELSE
                ...
                END;
                FormatAddr.SalesCrMemoBillTo(CustAddr, "Sales Invoice Header");
                ...
                END;
                ShowShippingAddr:=FormatAddr.SalesCrMemoShipTo(ShipToAddr, CustAddr, "Sales Invoice Header");
                ...
                IF UseSAFT AND bConLogo THEN BEGIN
                    ...
                    //+EX-SGG EX-QR 240322
                    "Sales Invoice Header".CALCFIELDS("QR Image"); //DATAITEM NOMBRADO ASI AUNQUE REFERENCIA A Sales Cr.Memo Header
                    IF NOT "Sales Invoice Header"."QR Image".HASVALUE THEN BEGIN
                        CLEAR(IStream);
                        CLEAR(OStream);
                        CLEAR(CduQRFunc);
                        TxtImageQR:=CduQRFuncATREVIA.ReturnTextForQRPT("No.", 1);
    ...
    var Text000: Label 'Vendor';
    Text001: Label 'Total %1';
    Text003: Label 'COPY';
    Text004: Label 'Sale - Credit Note %1';
    ...
    Text007: Label 'Specification of the VAT amount in ';
    Text008: Label 'Local currency';
    VALExchRate: Text[50];
    Text009: Label 'Exchange rate: %1/%2';
    CalculatedExchRate: Decimal;
    Text010: Label 'Sales - prepaid invoice %1';
    OutputNo: Integer;
    ...
    Text1100000: Label 'Total %1 Included VAT+EC';
    Text1100001: Label 'Total %1 Excluided VAT+EC';
    ...
    DueDateCaptionLbl: Label 'Expiration date';
    InvoiceNoCaptionLbl: Label 'Invoice No.';
    PostingDateCaptionLbl: Label 'Registration date';
    HdrDimsCaptionLbl: Label 'Header dimensions';
    PmtinvfromdebtpaidtoFactCompCaptionLbl: Label 'The payment of this invoice, to be released from the debt, has to be paid to the Factoring Company.';
    UnitPriceCaptionLbl: Label 'Unit price';
    DiscountCaptionLbl: Label 'Discount %';
    AmtCaptionLbl: Label 'Importe';
    VATClausesCap: Label 'VAT clause';
    PostedShpDateCaptionLbl: Label 'Registered shipping date';
    InvDiscAmtCaptionLbl: Label 'Invoice Discount Amount';
    SubtotalCaptionLbl: Label 'Subtotal';
    PmtDiscGivenAmtCaptionLbl: Label 'Given amount of payment discount';
    PmtDiscVATCaptionLbl: Label 'Payment Discount on VAT';
    ShpCaptionLbl: Label 'Shipment';
    LineDimsCaptionLbl: Label 'Line dimension';
    VATAmtLineVATCaptionLbl: Label 'VAT %';
    VATECBaseCaptionLbl: Label 'Base VAT+EC';
    VATAmountCaptionLbl: Label 'Amount VAT';
    VATAmtSpecCaptionLbl: Label 'VAT Amount Specification';
    VATIdentCaptionLbl: Label 'VAT identifier';
    InvDiscBaseAmtCaptionLbl: Label 'Invoice Discount Base Amount';
    LineAmtCaption1Lbl: Label 'Line Amount';
    InvPmtDiscCaptionLbl: Label 'Discounts on invoices and payments';
    ECAmtCaptionLbl: Label 'EC amount';
    ECCaptionLbl: Label 'EC %';
    TotalCaptionLbl: Label 'Total';
    VALVATBaseLCYCaption1Lbl: Label 'Base VAT';
    VATAmtCaptionLbl: Label 'Amount VAT';
    VATIdentifierCaptionLbl: Label 'VAT identifier';
    ShiptoAddressCaptionLbl: Label 'Shipping Address';
    PmtTermsDescCaptionLbl: Label 'Payment terms';
    ShpMethodDescCaptionLbl: Label 'Shipping method';
    PmtMethodDescCaptionLbl: Label 'Payment method';
    DocDateCaptionLbl: Label 'Document date';
    HomePageCaptionCap: Label 'Page';
    EmailCaptionLbl: Label 'Mail';
    CACCaptionLbl: Text;
    CACTxt: Label 'Special cash criterion regime';
    DisplayAdditionalFeeNote: Boolean;
    //-----------------------------INFORPRESS--------------------------------------------------------------------------------
    InvTitleTextLbl: Label 'CREDIT NOTE';
    ClientNoTextLbl: Label 'Customer No.';
    PostingDateTextLbl: Label 'Registration date';
    DueDateTextLbl: Label 'Expiration date';
    Text50002: Label 'Supplier: %1';
    TxtCust: Text[100];
    VATRegNoLbl: Label 'Customer VAT registration number';
    ...
    ShipmentMethodTextLbl: Label 'Shipping method';
    pais: Record 9;
    ...
    Text50000: Label 'BRANCH DETAILS: %1';
    ...
    Amount_SalesInvLineTextLbl: Label 'Import';
    ContinuedTxt: Label 'Continued';
    isAssistant: Boolean;
    SalesLine: Record 115;
    ...
    begin
        NextEntryNo:=1;
        IF "Sales Invoice Line"."Return Receipt No." <> '' THEN IF ReturnReceiptHeader.GET("Sales Invoice Line"."Return Receipt No.")THEN EXIT(ReturnReceiptHeader."Posting Date");
        IF "Sales Invoice Header"."Return Order No." = '' THEN EXIT("Sales Invoice Header"."Posting Date");
    ...
    begin
        ...
        SalesCrMemoHeader.SETFILTER("No.", '..%1', "Sales Invoice Header"."No.");
        SalesCrMemoHeader.SETRANGE("Return Order No.", "Sales Invoice Header"."Return Order No.");
        ...
        ReturnReceiptLine.SETRANGE("Return Order No.", "Sales Invoice Header"."Return Order No.");
        ...
        IF ReturnReceiptLine.FIND('-')THEN REPEAT IF "Sales Invoice Header"."Get Return Receipt Used" THEN CorrectShipment(ReturnReceiptLine);
