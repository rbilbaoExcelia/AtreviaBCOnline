report 52049 "Net Revenue Ranking VAL3"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/layouts/NetRevenueRankingVAL3.rdlc';
            ...
            dataitem("Dimension Value 2";349)
            {
                ...
                dataitem("Company"; Company)
                {
                    ...
                    dataitem("G/L Entry Year";17)
                    {
                        ...
                        begin
                            IF NOT job.GET("G/L Entry Year"."Job No.")THEN CurrReport.Skip();
                    ...
                    dataitem("G/L Entry Past Year";17)
                    {
                        ...
                        trigger OnAfterGetRecord()
                        begin
                            IF NOT job.GET("G/L Entry Past Year"."Job No.")THEN CurrReport.Skip();
                            IF NOT CustPriceGroup.GET(job."Customer Price Group")THEN CLEAR(CustPriceGroup);
                            //Año pasado
                            PastMemInt.Init();
