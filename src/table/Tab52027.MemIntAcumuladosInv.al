table 52027 "MemIntAcumulados Inv"
{
    fields
    {
...
//3526 - MEP - 2022 03 23 - Agregadas Keys
//Comentado
//Al subir el .app al entorno de pre prod, lanza error porque no permite cambiar las claves
/*keys
    {
