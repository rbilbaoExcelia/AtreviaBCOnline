report 52067 "Sales Invoice - Inforpress"
{
    // 148 OS.RM  07/06/2017  VEN.003   Informe factura venta
    // EX-OMI 180319 incluir moneda
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/layouts/SalesInvoiceInforpress.rdlc';
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    {
                        Caption = 'Solo 1 copia';
                        ToolTip = 'Solo 1 copia';
                        ApplicationArea = All;
                    }
                }
            }
    ...
    Job: Record Job;
    bConLogo: Boolean;
    //ConfigGasto: Record "Expenses Setup";
