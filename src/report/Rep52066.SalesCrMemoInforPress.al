report 52066 "Sales Cr.Memo-InforPress"
{
    // 148 OS.RM  07/06/2017  VEN.003   Abono de Venta
    // EX-OMI 180319 incluir moneda
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/layouts/SalesCrMemoInforPress.rdlc';
    Caption = 'Nota de credito - Venta';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Cr.Memo Header")
        {
            ...
            RequestFilterHeading = 'Notas de credito registradas';
    ...
    var Text000: Label 'Venderor';
    Text001: Label 'Total %1';
    Text003: Label 'COPIA';
    Text004: Label 'Venta - Nota de credito %1';
    ...
    Text1100000: Label 'Total %1 Includo IVA+EC';
    Text1100001: Label 'Total %1 Excluido IVA+EC';
    ...
    VATECBaseCaptionLbl: Label 'Base IVA+EC';
    ...
    //-----------------------------INFORPRESS--------------------------------------------------------------------------------
    InvTitleTextLbl: Label 'NOTA CREDITO';
    ...
    begin
        // LogInteraction := SegManagement.FindInteractTmplCode(4) <> '';//incompatibilidadV25
    ...
    // LogInteraction := SegManagement.FindInteractionTemplateCode(Enum::"Interaction Log Entry Document Type"::"Sales Inv.") <> '';//EX-RBF 200924
    end;
