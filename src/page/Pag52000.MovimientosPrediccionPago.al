page 52000 "Movimientos Prediccion Pago"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Exported to Payment File"; Rec."Exported to Payment File")
                {
                    ...
                    begin
                        if not ConfirmManagement.GetResponseOrDefault(ExportToPaymentFileConfirmTxt, true)then Error('');
                    end;
                }
                ...
                field("No. Doc. Certificado"; rec."No. Doc. Certificado")
                {
                    ApplicationArea = all;
                } //EX-RBF 150523
                ...
                field("Fecha Estimada Cobro"; rec."Fecha Estimada Cobro")
                {
                    ApplicationArea = all;
                    Editable = true;
                    Visible = true;
    ...
    begin
        ...
        SetDimVisibility();
        if(GetFilters() <> '') and not Find()then if FindFirst()then;
    end;
    ...
    protected var Dim1Visible: Boolean;
    Dim2Visible: Boolean;
    Dim3Visible: Boolean;
    Dim4Visible: Boolean;
    Dim5Visible: Boolean;
